...
INSERT INTO `users` VALUES (1,'Admin','admin','admin@greendata.com'),(2,'testUser','testPassword','testuser@greendata.com');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'kepszerkeszto_db'
--
